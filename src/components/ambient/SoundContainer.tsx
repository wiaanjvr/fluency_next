 ...
 * user clicks "Course" while ambient mode is active.
 *
...
export function SoundContainer({ className }: { className?: string }) {
  ...
  const [tab, setTab] = useState<Tab>(
    mode === "podcast" ? "podcast" : mode === "video" ? "video" : "radio",
  );
  ...
  const handleVideoClick = (v: AmbientVideo) => {
    playVideo(v);
  };
    ...
    >
      ...
      <div className="relative z-10 p-6 md:p-8 flex flex-col gap-6">
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          {/* LEFT — Now playing (audio) or Video player */}
          <div className="flex flex-col items-center lg:items-center gap-5 lg:w-[65%] lg:shrink-0">
            {isVideo ? (
              /* ── VIDEO PLAYER ──────────────────────────────────────────────── */
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                      {isLoading ? (
                        ...
                        <>
                          <Clapperboard
                            className="w-8 h-8"
                            style={{ color: "rgba(255,160,100,.5)" }}
                          />
                          <p
                          ...
                          >
                            No videos found for your language.
                          </p>
                          <button
                            onClick={retryVideo}
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span
                        ...
                        style={{
                          ...
                          color: "var(--seafoam)",
                          border: "1px solid rgba(61,214,181,.15)",
                          fontFamily: "Outfit,sans-serif",
                        }}
                      >
                        {currentVideo.category}
                      </span>
                      {currentVideo.duration_hint && (
                        <span
                          className="text-[10px]"
                          style={{
          ...
          {/* RIGHT — Track list */}
          <div
            className="lg:w-[35%] flex flex-col min-w-0"
          ...
          >
            ...
            >
              {(["radio", "podcast", "video"] as Tab[]).map((t) => (
                <button
                  key={t}
            ...
            <div className="overflow-y-auto flex-1" style={{ maxHeight: 300 }}>
              {isLoading ? (
                ...
                /* ── VIDEO LIST with category filter ──────────────────── */
                <>
                  {/* Category pills */}
                  <div
                  ...
                  >
                    {VIDEO_CATEGORIES.map(({ id, label, Icon }) => (
                      <button
                        key={String(id)}
                        onClick={() => setVideoCategory(id as string | null)}
